...
var greetSolutions = function (name) {
...
var numbersSolutions = [-3, 33, 38, 5];
console.log(Math.min.apply(Math, numbersSolutions));
// Exercise 4 - Spread Operator
var newArray = [66, 2];
newArray.push.apply(newArray, numbersSolutions);
